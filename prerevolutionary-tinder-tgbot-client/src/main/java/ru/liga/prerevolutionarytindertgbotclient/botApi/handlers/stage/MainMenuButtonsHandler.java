...
public class MainMenuButtonsHandler implements StageHandler {
    ...
    public MainMenuButtonsHandler(MessageHandlersFactory messageHandlersFactory, UserDataCacheStore userDataCacheStore) {
